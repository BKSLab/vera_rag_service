...
> Источник: `AGENT_VERA_ARCHITECTURE.md` (раздел "RAG Service — внутреннее устройство"), `AGENT_VERA_WBS.txt` (п. 3.1, 3.4, 4.1, 5.1–5.6).
...
- Цель: компенсировать слабость векторного поиска на юридических текстах (см. `AGENT_VERA_ARCHITECTURE.md`, раздел "Особенности поиска по юридическим текстам")
