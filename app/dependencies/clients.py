...
def get_enrichment_llm_client(httpx_client: HttpClientDep) -> LlmClient:
    ...
    return LlmClient(
        ...
        temperature=settings.polza_enrichment_llm_temperature,
...
def get_reranker_llm_client(httpx_client: HttpClientDep) -> LlmClient:
    ...
    return LlmClient(
        ...
        temperature=settings.polza_reranker_llm_temperature,
...
def get_query_expansion_llm_client(httpx_client: HttpClientDep) -> LlmClient:
    ...
    return LlmClient(
        ...
        temperature=settings.polza_query_expansion_llm_temperature,
